...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        finalScoreLabel.text = "Your final score is 0"
        finalScoreLabel.position = CGPoint(x: 480, y: 160)
    ...
    func createEnemy() {
        ...
        if numRounds >= 30 {
            ...
            addChild(gameOver)
            run(SKAction.playSoundFileNamed("gameOverS.caf", waitForCompletion: false))
